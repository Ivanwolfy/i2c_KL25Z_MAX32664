...
#define READ_HUB_SENSOR_STATUS_REG (0x43)
////////////////////////////////////////////////////////////////////////////////
...
uint8_t i2c_read_bytes(uint8_t slaveAddress, uint8_t familyByte, uint8_t indexByte ,uint8_t *data, uint8_t data_count){
	uint8_t dummy;
...
int main(void){
	...
	PRINTF("Read READ_HUB_SENSOR_STATUS_REG value\r\n");
	uint8_t data[256];
	uint8_t indexByte = 0x03;
	i2c_read_bytes(I2C_MAX32664_SLAVE_ADDRESS,READ_HUB_SENSOR_STATUS_REG,indexByte,data, 256);
